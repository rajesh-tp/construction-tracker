...
export function DeleteWorkerButton({ id, name }: { id: number; name: string }) {
        ...
        >
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-semibold text-text-heading">Delete Worker</h3>
                <p className="text-sm text-text-muted">This action cannot be undone.</p>
              </div>
            </div>

            <p className="mb-6 text-sm text-text-secondary">
              Delete <strong>&ldquo;{name}&rdquo;</strong>? Workers with attendance history will be deactivated instead of deleted, preserving payroll records.
            </p>
