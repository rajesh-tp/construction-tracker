...
import { updateUser, type ActionState } from "@/lib/actions";
...
export function EditUserForm({ user, contractors, constructions }: EditUserFormProps) {
        ...
        {selectedRole === "contractor" && (
          <div className="sm:col-span-2">
            ...
            <select
              id="contractorId"
              name="contractorId"
              defaultValue={user.contractorId ?? ""}
              className="w-full rounded-lg border border-border-strong px-4 py-2.5 text-text-heading transition-colors focus:border-focus-border focus:ring-2 focus:ring-focus-ring focus:outline-none"
            >
