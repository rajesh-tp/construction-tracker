        ...
        >
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-semibold text-text-heading">Delete User</h3>
                <p className="text-sm text-text-muted">This action cannot be undone.</p>
              </div>
            </div>

            <p className="mb-6 text-sm text-text-secondary">
              Are you sure you want to delete <strong>&ldquo;{name}&rdquo;</strong>? Their construction assignments will also be removed.
            </p>
